...
contract('ABCTokenCrowdsale', function([_, wallet, investor1, investor2, foundersFund, foundationFund, partnersFund]){
    ...
    beforeEach(async function (){
        ...
        this.crowdsale = await ABCTokenCrowdsale.new(
            this.rate, 
            this.wallet, 
            this.token.address,
            this.cap,
        ...
        await this.crowdsale.addManyToWhilelist([ investor1, investor2 ]);
    ...
    describe('timed crowdsale', async function() {
    ...
    describe('whitelisted crowdsale', async function() {
        it('reject contribution from non-whitelisted investors', async function() {
    ...
    describe('refundable crowdsale', async function() {
        beforeEach(async function(){
    ...
    describe('crowdsale stages', function(){
        ...
        it('it starts in PreICO rate', async function() {
            const rate = await this.crowdsale.rate();
    ...
    describe('buyTokens()', function() {
        ...
        describe('token transfers', function() {
            ...
            //it enables token transfers after sale is over - see finalizaton
        });
        ...
        describe('finalizing the crowdsale', function() {
            ...
            describe('when the goal is reached', function() {
                ...
                it('handles goal reached', async function() {
                    ...
                    partnersAmount = foundersAmount.toString();
                    partnersAmount = foundersAmount / (10 ** this.decimals);
                    ...
                    await this.vault(investor, { from: investor1, }).should.be.rejectedWith(EVMRevert);
                });
            });
        ...
        describe('token distribution', function() {
            it('tracks token distribution correctly',async function() {
                ...
                const founderPercentage = await this.crowdsale.founderPercentage();
                founderPercentage.should.be.bignumber.equal(this.founderPercentage, 'has correct founderPercentage');
                
                const foundationPercentage = await this.crowdsale.foundationPercentage();
                foundationPercentage.should.be.bignumber.equal(this.foundationPercentage, 'has correct foundationPercentage');
            ...
            it('is a valid percentage breakdown',async function() {
                ...
                const total = tokenSalePercentage.toNumber() + founderPercentage.toNumber() + foundationPercentage.toNumber() + partnersPercentage.toNumber();
